...
export const saveDataToFile = (newData: Data[], filePath: string = "data.json") => {
  try {
    ...
    fs.writeFileSync('log.json', JSON.stringify(existingData, null, 2));
    ...
    try {
      ...
      fs.writeFileSync('log.json', JSON.stringify(newData, null, 2));
...
// this function is used to overwrite the existing file with null data
